...
#include "ascon/ascon128v12/ref/crypto_aead.h"
int 
dtls_encrypt(const unsigned char *src, size_t length,
	     unsigned char *buf,
	     const unsigned char *nonce,
...
#elif defined (TLS_EXP_CIPHER_ASCON128A) 
#include "ascon/ascon128av12/ref/crypto_aead.h"
int 
dtls_encrypt(const unsigned char *src, size_t length,
	     unsigned char *buf,
	     const unsigned char *nonce,
...
#include "ascon/ascon80pqv12/ref/crypto_aead.h"
int 
dtls_encrypt(const unsigned char *src, size_t length,
	     unsigned char *buf,
	     const unsigned char *nonce,
...
#elif defined (TLS_EXP_CIPHER_TINYJAMBU256) 
#include "tinyjambu/tinyjambu256/ref/crypto_aead.h"
int 
dtls_encrypt(const unsigned char *src, size_t length,
	     unsigned char *buf,
	     const unsigned char *nonce,
